...
export const trips = [
  {
    ...
    photos: [
      {
        url: "/images/travel/turtle-friend.jpeg",
        alt: "Snorkeling with turtle",
        caption: "Making turtle friends",
      },
      {
        url: "/images/travel/turtle-snorkle.jpeg",
        alt: "Turtle underwater",
        caption: "Swimming alongside sea turtles",
      },
      {
        url: "/images/travel/blue-foot-boobie.jpeg",
        alt: "Blue-footed booby",
        caption: "Blue-footed booby on the rocks",
      },
      {
        url: "/images/travel/sea-lions.jpeg",
        alt: "Sea lions colony",
        caption: "Sea lions relaxing on the beach",
      },
      {
        url: "/images/travel/isabella-island.jpeg",
        alt: "Isabela Island sign",
        caption: "Isabela Island welcome sign",
      },
      {
        url: "/images/travel/equator.jpeg",
        alt: "Equator monument",
        caption: "Standing at the equator line",
      },
      {
        url: "/images/travel/sunset-boats.jpeg",
        alt: "Sunset over boats",
        caption: "Beautiful Galapagos sunset",
      },
      {
        url: "/images/travel/sea-horse.jpeg",
        alt: "Seahorse underwater",
        caption: "Seahorse clinging to coral structure",
      },
      {
        url: "/images/travel/inactive-volcano.jpeg",
        alt: "Inactive volcano landscape",
