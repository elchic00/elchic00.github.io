      ...
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center mt-10">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p className="mb-7 leading-relaxed">
            A motivated student of computer science, interested in working with people who
            want to solve meaningful problems with software engineering.
            <br />
            <br />
          ...
          <ul className="flex lg:flex-row lg:space-x-4 flex-col list-none mb-5">
            ...
            >
              <svg
                  ...
                  data-prefix="fab"
                  data-icon="github"
                  className="svg-inline--fa fa-github w-6 text-white hover:text-white mr-3"
                  role="img"
