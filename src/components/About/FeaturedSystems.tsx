...
const featuredSystems: FeaturedSystem[] = [
  ...
  },
  {
    ...
    value:
      "A from-source llama.cpp build serving three models on GPU hardware the project doesn't officially list as supported — every call traced and nightly graded.",
    metric: "33 t/s",
