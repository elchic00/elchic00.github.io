    ...
    <section id="accessibility-expertise" className="relative py-20 bg-slate-900">
      <div className="container mx-auto px-5 sm:px-8 md:px-10">
          ...
          <article className="bg-gradient-to-br from-slate-800 to-slate-900 border-2 border-cyan-500/30 rounded-2xl p-8 shadow-xl">
            ...
            <div className="space-y-4">
              ...
              <div className="border-l-4 border-green-500/50 pl-4">
                ...
                <p className="text-slate-300 mt-1">
                  <strong className="text-white"> Audit score: 72% <span className="text-slate-500">→</span>{" "}
                    100% </strong>
          ...
          <article className="bg-gradient-to-br from-slate-800 to-slate-900 border-2 border-purple-500/30 rounded-2xl p-8 shadow-xl">
            ...
            <div className="space-y-4">
              ...
              <div className="border-l-4 border-purple-500/50 pl-4">
                ...
                <p className="text-slate-300 mt-1">
                  {" "}
                  Implemented the same WCAG AAA engineering patterns used to achieve a 100/100 Lighthouse score on this portfolio. Applied to mobile with offline-first SQLite storage, large touch targets for motor difficulties, and high-contrast PECS visuals. React Native for cross-device parity.{" "}
                </p>
              </div>
              <div className="border-l-4 border-green-500/50 pl-4">
                <span className="text-green-400 font-semibold text-sm uppercase tracking-wide">
                ...
                <p className="text-slate-300 mt-1">
                  ...
                  <strong className="text-white"> Same 100/100 Lighthouse accessibility score </strong>{" "}
                  as enterprise work. Open-sourced for special needs community adoption.
                </p>
              </div>
            </div>
          </article>
        ...
        <div className="mt-12 text-center">
          ...
          <a href="https://pagespeed.web.dev/analysis?url=https://elchic00.github.io/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-cyan-600 to-purple-600 text-white rounded-lg font-semibold hover:from-cyan-500 hover:to-purple-500 transition-all duration-300 shadow-lg hover:shadow-cyan-500/30" >
